...
def attack(char_name: str, char_class: str) -> str:
    """Описывает количество наносимого урона."""
...
def defence(char_name: str, char_class: str) -> str:
    """Описывает количество блокируемого урона."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Описывает эффект применения специального умения."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Описывает персонажа и предлагает ввести команду для тренировки."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Описывает выбор персонажа и его преимущества."""
    approve_choice: str = ''
    char_class: str = ''
